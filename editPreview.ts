...
export function drawCrosshair(renderer: Renderer, at: Vec2, color: string, size = 0.5): void {
...
export function rotatePreviewPoint(p: { x: number; y: number }, rotationDeg: number): Vec2 {
 ...
 */
export function drawLabelFlagPreview(
	renderer: Renderer,
	kind: string,
	worldOrigin: Vec2,
	text: string,
