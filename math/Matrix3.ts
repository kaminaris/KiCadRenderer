...
export class Matrix3 {
	 ...
	 */
	static fromDOMMatrix(m: DOMMatrix): Matrix3 {
		return new Matrix3([
			m.m11, m.m12, m.m14,
			m.m21, m.m22, m.m24,
			m.m41, m.m42, m.m44,
	 ...
	 */
	*transformAll(vecs: Iterable<Vec2>) {
	 ...
	 */
	static transformAll(mat: Matrix3 | null, vecs: Vec2[]): Vec2[] {
		if (!mat) {
			return vecs;
		}
